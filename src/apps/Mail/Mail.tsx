      ...
      <div className="mail-content">
        ...
        <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <input
              ...
              onBlur={() => {
                if (!formData.name.trim()) {
                  setErrors((prev) => ({
                    ...prev,
                    name: `${mailT.form.name} ${mailT.form.validation.required}`,
                  }));
                }
              }}
            ...
            <input
              ...
              onBlur={() => {
                if (!formData.email) {
                  setErrors((prev) => ({
                    ...prev,
                    email: `${mailT.form.email} ${mailT.form.validation.required}`,
                  }));
                } else if (!validateEmail(formData.email)) {
                  setErrors((prev) => ({
                    ...prev,
                    email: mailT.form.validation.email,
                  }));
                }
              }}
            ...
            <input
              ...
              onBlur={() => {
                if (!formData.phone) {
                  setErrors((prev) => ({
                    ...prev,
                    phone: `${mailT.form.phone} ${mailT.form.validation.required}`,
                  }));
                } else if (!validatePhone(formData.phone)) {
                  setErrors((prev) => ({
                    ...prev,
                    phone: mailT.form.validation.phone,
                  }));
                }
              }}
            ...
            <input
              ...
              onBlur={() => {
                if (!formData.subject.trim()) {
                  setErrors((prev) => ({
                    ...prev,
                    subject: `${mailT.form.subject} ${mailT.form.validation.required}`,
                  }));
                }
              }}
            ...
            <textarea
              ...
              onBlur={() => {
                if (!formData.message.trim()) {
                  setErrors((prev) => ({
                    ...prev,
                    message: `${mailT.form.message} ${mailT.form.validation.required}`,
                  }));
                } else if (formData.message.trim().length < 10) {
                  setErrors((prev) => ({
                    ...prev,
                    message: mailT.form.validation.messageMinLength,
                  }));
                }
              }}
          ...
          <div className="form-footer">
            ...
            {submitSuccess && (
              <div className="success-message">{mailT.form.success}</div>
            )}
          </div>
        </form>
        ...
        <div className="contact-info">
          ...
          <div className="contact-methods">
            <a
              href="mailto:rafaelfurtado313@gmail.com"
              className="contact-method"
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
                  d="M3 6L10 11L17 6M3 6V14C3 14.5523 3.44772 15 4 15H16C16.5523 15 17 14.5523 17 14V6M3 6L10 2L17 6"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinejoin="round"
                />
            ...
            <a
              href="https://linkedin.com/in/rafael-ildefonso"
              target="_blank"
            ...
            <a
              href="https://github.com/rafaelildefonso"
              target="_blank"
              rel="noopener noreferrer"
              className="contact-method"
            >
